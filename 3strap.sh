...
pacstrap /mnt base base-devel linux-firmware e2fsprogs dosfstools os-prober efibootmgr btrfs-progs ntfs-3g snapper snap-pac snap-pac-grub
...
if [ "$DECHOICE" = "kaidaplasma" ]; then
      ...
      pacstrap /mnt base xorg xorg-xinit xterm i3-gaps ttf-dejavu dmenu i3status sddm
